export default {
  ...
  "skills": [
    ...
    },
    {
      ...
      "description": "Advanced knowledge of JavaScript, TypeScript, NodeJS, HTML, CSS, SCSS. Basic knowledge of Java SE, PHP"
    },
    {
    ...
    {
      "name": "I speak",
      "description": "English, Ukrainian, Russian, Dutch (A2)"
    }
  ],
  "certificates": [
    {
  ...
  "ownProjects": [
    {
      ...
      "description": "Open-source isomorphic javascript module for reporting data (logs) to remote log storages like SumoLogic and Loggly with support of different reporting strategies",
      "links": [
        {
          "name": "website",
          "icon": "",
